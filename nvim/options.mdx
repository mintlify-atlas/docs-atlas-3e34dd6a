...
This configuration makes minimal changes to LazyVim's default options, following the principle of relying on sensible defaults. Custom options are defined in `lua/config/options.lua`:
